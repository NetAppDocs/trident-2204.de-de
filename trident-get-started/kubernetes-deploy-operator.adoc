...
* Manuell: Trident bietet ein link:https://github.com/NetApp/trident/blob/stable/v22.04/deploy/bundle.yaml["Bundle.yaml"^] Datei, mit der der Operator installiert und zugehörige Objekte erstellt werden können.
