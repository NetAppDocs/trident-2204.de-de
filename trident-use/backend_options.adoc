...
== Managen Sie tridentctl Back-Ends mit TridentBackendConfig
...
== Managen Sie tridentBackendConfig-Back-Ends mit tridentctl
...
=== Schritt 1: Bestätigen Sie, dass die deletionPolicy auf beibehalten eingestellt ist
